            ...
            <nav class="navbar navbar-fixed-top bg-maroon">
                <div class="container">
                    <div class="navbar-header">
                        <a href="?" class="animated bounce navbar-brand" style="padding:5px 15px;"><b>CANDY</b>
                            INSTALLER</a>
                    </div>
                </div>
            </nav>
                    ...
                    <div class='row'>
                        ...
                        <div class="animated flipInX login-box " style='margin-top:1%;'>
                            ...
                            <div class="  login-box-body bg-teal">
                                <p class="login-box-msg"><b>Database Belum Terbentuk Silahkan Klik Tombol dibawah Untuk
                                        membuat database</b></p>
                                <div class="row">

                                    <!-- /.col -->
                                    <div class="col-xs-12">
                                        <form action='' method='post'>
                                            <button name='buat' class="btn btn-primary btn-raised  btn-block"
                                                <?php echo $ket2 ?>>1. Buat</button>
                                        </form>
                                        <form action='' method='post'>
                                            <button name='buat2' class="btn btn-danger btn-raised  btn-block"
                                                <?php echo $ket ?>>2. Import</button>
                                        </form>
                                    </div>
                                    <!-- /.col -->
                                </div>
