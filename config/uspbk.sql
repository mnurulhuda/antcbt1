...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Feb 2020 pada 03.32
...
(1, 'internal', 'SELAMAT DATANG DI ANT CBT', 1, '<p>Silahkan pelajari aplikasi ini untuk keperluan Ujian Berbasis Digital. Semoga dengan aplikasi ini bisa bermanfaat untuk pendidikan.</p>', '2020-02-23 20:27:12');
...
(1, 'ANT CBT', 'K05150115', 'SMK ABDI NEGARA TUBAN', 'SMK', 'Nanang Slamet Mulyono, S.Pd', '19701224 200701 1 008', 'Jl. Dr. Wahidin Sudirohusodo No. 798 tuban', 'Tuban', 'Tuban', '0356 8832043', '-', 'smkabdinegara.sch.id', 'smk.abdinegara798@gmail.com', 'dist/img/logo6.png', '', 'KARTU PESERTA\nUJIAN SEKOLAH BERBASIS KOMPUTER', 'USPBK', '2.5', 'http://192.168.0.200/antcbt', 'Asia/Jakarta', 'pusat', 'SERVER1', '', 'localhost', 'root', '', 'uspbk', '8cce47df-aae7-4274-83cb-5af3093eab56', '20505005');
