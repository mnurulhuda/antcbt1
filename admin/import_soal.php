        ...
        <form id="formsoalword" action='<?=$homeurl?>/admin/import_word.php'
            ...
            <div class='box box-solid'>
                ...
                <div class='box-body'>
                    ...
                    <p>
                        Sebelum meng-import pastikan file yang akan anda import sudah dalam bentuk Ms. Word (.docx) dan
                        format penulisan harus sesuai dengan yang telah ditentukan. <br />
                    </p>
                </div><!-- /.box-body -->
                <div class='box-footer'>
        ...
        <form id='formsoalbee' action='' method='post' enctype='multipart/form-data'>
            <div class='box box-solid'>
                <div class='box-header  bg-yellow with-border'>
                    ...
                    <div class='box-tools pull-right '>
                        <button type='submit' name='importbee' class='btn btn-sm btn-flat btn-success'><i
                                class='fa fa-check'></i> Import</button>
                        <a href='?pg=<?=$pg?>' class='btn btn-sm bg-maroon' title='Batal'><i
                                class='fa fa-times'></i></a>
                    </div>
    ...
    <div class='col-md-6'>
        <div class='box box-danger'>
            ...
            <div class='box-body'>
                ...
                <br />
                <p>
                    Silahkan upload file pendukung soal seperti gambar dan audio ke dalam arsip bertipe zip setelah itu
                    upload kesini dan komputer akan mengekstraknya ke dalam folder files <br />
                </p>
                <?php
if (isset($output)) {
    echo $output;
